...
#API_HOST = 'be.mooquant_mooquant_huobi.com'
API_HOST = 'api.mooquant_mooquant_huobi.pro'
...
class ApiError(BaseException):
    def __init__(self, message):
        ...
        ErrorShow('%s: %s' % (self.__class__.__name__, self.__message))
